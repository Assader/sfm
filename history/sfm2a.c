...
void readConf(part *p, part *pp, char *td, char *term, int keys[]){
    char tmp[128], ttmp[8];
    const char *cnf[] = {"Another window", "Quit", "Hidden mode", "Same folder", "Change folder", "New folder", "Copy", "Move", "Remove", "Rename", "Parent folder", "Go to line", "Execute", "Info", "EC"};
    int sch=0, ssch=0;
    dictionary *ini;
